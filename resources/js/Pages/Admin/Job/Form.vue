...
<template>
    <Head v-if="form_type == 'create'" title="Создание вакансии"/>
    <Head v-else title="Редактирование вакансии"/>

    <Authenticated>
        <div class="mx-2">
            <div class="rounded-2xl bg-white">
                <h2 class="text-xl mt-2 p-4" v-if="form_type == 'create'">Создание вакансии</h2>
                <h2 class="text-xl mt-2 p-4" v-else>Редактирование вакансии</h2>
            </div>
