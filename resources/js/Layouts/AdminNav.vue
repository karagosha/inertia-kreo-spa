            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="shrink-0 flex items-center">
                        <Link :href="route('home')" class="text-white font-bold">
                            Управление
<!--                            <BreezeApplicationLogo class="block h-9 w-auto"/>-->
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <BreezeNavLink :href="route('feedback.index')" :active="route().current('feedback.index')">
                            Отзывы
                        </BreezeNavLink>
                    </div>
                </div>
                            ...
                            <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button type="button"
                                                    ...
                                                    rounded-md text-gray-300 bg-gray-800 hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
        ...
        <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                <BreezeResponsiveNavLink :href="route('projects.index')" :active="route().current('projects.index')">
                    Проекты
